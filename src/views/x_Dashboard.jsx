              ...
              <Card className="card-stats">
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <Col md="4" xs="6">
                        <div className="bg-warning percentTagImageTop">55%</div> 
                        <img src={img1}  />
                      </Col>
                      <Col md="4" xs="6">
                        <div className="bg-danger percentTagImageTop">55%</div> 
                        <img src={img1}  />
                      </Col>
                    </Row>
                    <Row className="mt-4">
                      <Col md="4" xs="6">
                        <div className="bg-primary percentTagImageTop">55%</div> 
                        <img src={img1}  />
                      </Col>
                      <Col md="4" xs="6">
                        <div className="bg-info percentTagImageTop">55%</div> 
                        <img src={img1}  />
                      </Col>
                      <Col md="4" xs="6">
                        <div className="bg-success percentTagImageTop">55%</div> 
                    ...
                    <Card className="dashboardTable">
                      ...
                      <CardBody>
                        <Table responsive>
                          ...
                          <tbody>
                            <tr>
                              <td><span className="bg-primary projectLetter">F</span> <span className="mlr10"> APPLOYEE - Development </span></td>
                              <td>Tue, Nov 27, 2018</td>
                              <td>4:40 pm</td>
                              <td>6:10 pm</td>
                              <td>1:30:19</td>                              
                            </tr>
                      ...
                      <CardBody>
                        <Table responsive>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <span className="bg-primary projectLetter">
                                  F
                                </span>
